...
try {
   mongoose.connect("mongodb+srv://abhishekbarnwal1000:1234@crud.wqpjpg1.mongodb.net/?retryWrites=true&w=majority&appName=crud", { useNewUrlParser: true },{ useUnifiedTopology: true });
  console.log("serverr connected ");
} catch (error) {
  
}
mongoose.connect("mongodb+srv://abhishekbarnwal1000:1234@crud.wqpjpg1.mongodb.net/?retryWrites=true&w=majority&appName=crud");
var fs = require('fs');
